...
export const MobileNav = (props) => {
    ...
    const { toggleIcon, onSwitch } = props;

    return (
        <>
            <i className={toggleIcon ? "fas fa-times" : "fas fa-bars"} onClick={() => onSwitch()}></i>
            <ul className={toggleIcon ? "navbar-collapse" : "collapse navbar-collapse"}>
